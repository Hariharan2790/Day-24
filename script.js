...
async function fetchData() {
    try {
        const response = await fetch("https://61d19a13da87830017e592a4.mockapi.io/:users")
        ...
        tableList.addEventListener('click', (e) => {
            ...
            if (deleteButtonIsPressed) {
                if (confirm("Are you sure want to delete this users?")) {
                    fetch(`https://61d19a13da87830017e592a4.mockapi.io/:users/${idValue}`, {
                        method: "DELETE",
...
postData.addEventListener('submit', async function (e) {
    ...
    if (isEdit == true) {
        try {
            await fetch(`https://61d19a13da87830017e592a4.mockapi.io/:users/${idValues.value}`, {
                method: "PUT",
                headers: {
